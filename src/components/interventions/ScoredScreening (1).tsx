...
/* =======================
   computeResult
   Berechnet den dominanten Typ aus allen Antworten
======================= */
...
const QuestionCard = memo(function QuestionCard({
  ...
  return (
    ...
    >
      ...
      {/* Avatar spricht */}
      <AvatarBubble title={question.text} />
...
function ScoredScreening({ data }: { data: ScoredScreeningData }) {
  ...
  const handleComplete = useCallback(async () => {
    ...
    if (import.meta.env.DEV) {
      console.log("[ScoredScreening] Winner:", winner)
      console.log("[ScoredScreening] Scores:", scores)
      console.log("[ScoredScreening] Patch:", JSON.stringify(profilePatch, null, 2))
    }
    ...
    try {
      ...
      if (import.meta.env.DEV) console.error("[ScoredScreening] patchUserProfile fehlgeschlagen:", err)
      return
    }
